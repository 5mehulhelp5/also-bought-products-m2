...
namespace MageMoto\AlsoBought\Block\Adminhtml\System;
...
/**
 * Class SnippetCode
 * @package MageMoto\AlsoBought\Block\Adminhtml\System
 */
class SnippetCode extends Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $html .= '<pre style="background-color: #f5f5dc"><code>{{block class="MageMoto\AlsoBought\Block\Product\ProductList\Widget" title="Who bought this item also bought" design="slider" show_list="price,addtocart,review,addto"}}</code></pre>';

        $html .= '<strong>' . __('Template .phtml file') . '</strong><br />';
        $html .= '<pre style="background-color: #f5f5dc"><code>' . $this->_escaper->escapeHtml(
            '<?php echo $block->getLayout()->createBlock("MageMoto\AlsoBought\Block\Product\ProductList\Widget")
            ->setData([
        ...
        $html .= '<pre style="background-color: #f5f5dc"><code>' . $this->_escaper->escapeHtml(
            '<block class="MageMoto\AlsoBought\Block\Product\ProductList\Widget" name="mmalsobouhgt-snippet-code" >
    <arguments>
